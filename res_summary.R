setwd("//jackdaw.biostat.wusm.wustl.edu/r.lu/simBART/results")
funcs = c("f1") #, "f2")
P = 3
sigmas = c("01", "1", "3", "5")
ns = c(100)#, 100)
...
infoTable <- table1 <- table2 <- table3 <- table4 <- table5 <- NULL
...
save(infoTable_sum, table1_sum, table2_sum, table3_sum,table4_sum, table5_sum,
     file = "f1_P3_n100_sum.Rdata")
